  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-2">
        ...
        <div className="bg-indigo-600 text-white px-3 py-1 rounded-full text-sm font-bold shadow-sm whitespace-nowrap">
          ${property.weekly_rent}/wk
        </div>
      </div>
      
      <p className="text-slate-600 text-sm flex items-center mb-4 line-clamp-1">
