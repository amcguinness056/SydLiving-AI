...
## 📸 Mandatory Visual Assets & Screenshot Policy

> [!IMPORTANT]
> **ANY UI/UX modification requires updating the canonical documentation screenshots before submitting or updating a Pull Request.**
>
> Whenever you change components, layout, styling, themes, or feature workflows in the frontend, you MUST regenerate the visual assets and ensure `README.md` reflects the current user interface.
...
Before opening or updating a Pull Request, all of the following checks must pass:
...
# 3. Screenshot Refresh (if UI was modified)
./scripts/update_screenshots.sh
```
